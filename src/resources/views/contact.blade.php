...
<div class="contact-form">
    <h3 class="contact__logo">Contact</h3>
        ...
        <form class="contact-form" action="/confirm" method="post">
            ...
            <div class="contact-form__group contact-form__name-group">
                ...
                <div class="contact-form__name-inputs">
                    <input class="contact-table__input-name" type="text" name="first_name" id="name" value="{{ old('first_name') }}" placeholder="例:山田">
                    <input class="contact-table__input-name" type="text" name="last_name" id="name" value="{{ old ('last_name') }}" placeholder="例:太郎">
                </div>
                <!-- バリデーションエラー -->
            ...
            <div class="contact-form__group">
                ...
                <div class="contact-form__gender-inputs">
                    ...
                    <div class="contact-form__gender-option">
                        <label class="contact-form__gender-label">
                            <input class="contact-form__gender-input" type="radio" name="gender" id="female" value="2" {{ old('gender')==2 || old('gender')==null ? 'checked' : ''}}>
                            <span class="contact-form__gender-text">女性</span>
                        </label>
                    </div>
                    <div class="contact-form__gender-option">
                        <label class="contact-form__gender-label">
                            <input class="contact-form__gender-input" type="radio" name="gender" id="other" value="3" {{ old('gender')==3 || old('gender')==null ? 'checked' : ''}}>
                            <span class="contact_form__gender-text">その他</span>
                        </label>
                    </div>
                </div>
                <!-- バリデーションメッセージ -->
